...
namespace Open_Miracle
{
    public partial class formMDI : Form
    {
        ...
        private void stockJournalReportToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                if (CheckUserPrivilege.PrivilegeCheck(PublicVariables._decCurrentUserId, "frmStockJournelReport", "View"))
                {
        ...
        private void purchaseInvoiceReportToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                if (CheckUserPrivilege.PrivilegeCheck(PublicVariables._decCurrentUserId, "frmPurchaseReport", "View"))
                {
